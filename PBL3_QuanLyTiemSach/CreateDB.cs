        ...
        //: DropCreateDatabaseAlways<DBQuanLyTiemSach>
    {
        protected override void Seed(DBQuanLyTiemSach context)
        {
            ...
            context.NhanViens.AddRange(new NhanVien[]
            {
                ...
                new NhanVien { MaNV = 2, TenNV = "Nguyễn Thị B", GioiTinh = false, NgaySinh = Convert.ToDateTime("2004-12-30"), DiaChi = "Đà Nẵng, Việt Nam", Luong = 150000.0, SDT = "0912345678"},
                new NhanVien { MaNV = 3, TenNV = "Trần Thị B", GioiTinh = false, NgaySinh = Convert.ToDateTime("2004-01-01"), DiaChi = "Thừa Thiên Huế, Việt Nam", Luong = 150000.0, SDT = "0914569978"},
            });
            /*
